...
tile14 = Tile((reset + "The eastern road leads to a massive circular stone building, the walls of this edifice engraved with depictions of battle."), ("You see that this place is called the Arena, where glorious battle could be done between you and other powerful opponents, without any risk of death."), 14, {"West":11})
...
tile18 = Tile((reset + "The main keep of the fortress is right before you, a pair of stone gargoyles grinning over the heads of a pair of heavily-armored guardsmen."), (reset + "The heavy wooden doors open wide into a long, vaunted, hall, a carpet of scarlet red stretching and branching off into the cathedral-like interior of the castle keep."), 18, {"South":13})

tile19 = Tile((reset + "Even the arena's entrance gate is a grand sight, as effigies of past champions stand vigil in poses of victory, as plaques detail their exploits."), (reset + "You read the plaques: \nHaerclus Asmitheus, the Lord of Hunger, who ate his opponents alive when they failed.\nGarth Karnis, the Champion of Steel, who had never been injured in a single match.\nEir Goromir, the Bone-Crusher, who turned his enemies to dust under his hammer larger than him.\nBead Tyrhall, the Ash Harpy, who burnt her enemies to piles of ash.\nGiorkkos, the Cloudy Day, who slew arenas of fighters with a single spell."), 19, {"South":14})
...
tilesDict = {1:tile1, 2:tile2, 3:tile3, 4:tile4, 5:tile5, 6:tile6, 7:tile7, 8:tile8, 9:tile9, 10:tile10, 11:tile11, 12:tile12, 13:tile13, 14:tile14, 15:tile15, 16:tile16, 17:tile17, 18:tile18, 19:tile19, -1:dungeonTile1, -2:dungeonTile2, -3:dungeonTile3, -4:dungeonTile4, -5:dungeonTile5}
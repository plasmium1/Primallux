...
tile31 = Tile(
    (reset +
     "Moss creeps over the bark of these trees, forming a layer of green over thick trunks as wide as two men."
     ),
    ("Creeping vines flowering with small yellow blooms drape over the mosses."
     ),
    31, {
        "West": 30,
        "South": 32
    ...
    findNoEncounterText=
    ("You feel like you are being stalked amongst these trees, only seeing faint shifts in the dry needles over the ground."
     ),
    repNoEncounterText=
    ("The gaze from within these trees is neutral, perhaps even friendly, as Nature welcomes you in its wild lands."
     ),
    noMoreMobsText=
    ("Light breezes flow through the trees, carrying faint birdsong from further lands."
     ),
    encounter=mobDict["Forest Wolf"],
    encounterChance=16)

tile32 = Tile((
    reset +
    "The forest's floor is covered with encroaching smaller plants that cover the soil between the trees, while a forest trail stretches from the west to the east."
), ("You see that these plants are constructed of little fronds, who hold small leaves growing upon them, where occasionally, you spot tiny sacs beneath a leaflet."
    ),
              32, {
                  "North": 31,
                  "West": 33
...
tile33 = Tile((
    reset +
    "The dirt rises into a hill to the west, as more uneven ground breaks into the forest, the dirt now filled with myriad small chips of rock."
), ("Among these shards of stone that lie on the forest floor, you spot a shattered half of a weathered boulder, half of its form cleaved away, revealing a grievous wound in a once large rock."
    ), 33, {
        "North": 30,
        "West": 9,
        "East": 32
...
tile34 = Tile(
    (reset +
     "Deeper into the forest, you spot the branches close together, as pine fronds intersect each other, each seeking for, and turning the sun's rays into thin points of light on the dirt."
     ),
    ("Life seems to be flourishing, in the places shaded by tree leaves, as small plants with purple sickle-shaped leaves growing amongs knotted roots."
     ),
    34, {
        "South": 35,
        "East": 28
    ...
    questFlavorText={
        "Bandits|2":
        (reset +
         "Bloodied tracks lead down to the south. You feel that your quarry is close, perhaps even watching you, already."
         ),
        "Bandits|3":
        (reset +
         "Bloodied tracks lead down to the south. You feel that your quarry is close, perhaps even watching you, already."
    ...
    questSearchText={
        "Bandits|3":
        (reset +
         "An acrid smell fills the air, the smell of overcooked, charred, meat."
         )
    })

tile35 = Tile(
    (reset +
     "A small clearing lies here, where there once was a great tree that stretched into the skies, now reduced to a behemoth moss-grown table of circle-marked wood."
     ),
    ("Small yellow flowers dot the green carpeting over the ground, as the clear blue skies show above in the sky, opening a window of sunlight into the clearing guarded by brown-clad sentries."
     ),
    35, {
        "North": 34,
        "East": 36
    ...
    questFlavorText={
        "Bandits|3":
        (reset +
         "You enter a small clearing in the forest, where a bandit camp lies, tents placed in the forest, the remnants of a burnt-out campfire, and the laughing of cruel men."
         )
    },
    questEncounters={
        "Bandits|3": [[mobDict["Forest Bandit 1"], mobDict["Forest Bandit 2"]],
                      8],
        "Bandits|4": mobDict["Bandit Leader Toderick"]
    },
    questEntryEncounter=True)

tile36 = Tile((
    reset +
    "The road cuts a line through the forest, as if defying the wild sanctity of nature with its presence."
), ("You see twisted boughs, elder bark, and a sense of permanence, and beings born of a long-past era, around you. These knotted trees seem to be thick enough for you to climb."
    ),
              36, {
                  "North": 28,
                  "East": 37,
...
tile37 = Tile(
    (reset +
     "The ground is carpeted with yellowed pine needles, as light shines down through the bare branches of a dying tree."
     ),
    ("Between the fallen needles, you spot the tracks of many animals. It seems this clearing has been the home of many."
     ),
    37, {
        "North": 9,
        "West": 36
    },
    encounter=mobDict["Forest Fox"],
    encounterChance=15,
    findNoEncounterText=
    "While the animals of the forest once were in these lands, they don't seem to show themselves to their visitor.",
    repNoEncounterText=
...
dungeonTile1 = Tile(
    ...
    interactible=interact2,
    repNoEncounterText=
    ("The hungry wolves decide not to attack you for food, though have none to spare for you."
     ),
    findNoEncounterText=
    ("Faint shapes flicker through the shadows, as light snarls caress the very edges of your hearing."
     ),
    noMoreMobsText=
    ("The cave has fallen silent, leaving only dimly-lit rocks glistening of moisture."
     ),
    encounter=mobDict["Hungry Wolf"],
    encounterChance=20)
...
dungeonTile2 = Tile(
    (reset +
     "The cave is filled with stones, and your feet splash in small puddles of water."
     ), ("The cave bends, turning away out of your vision."),
    -2, {
        "West": -1,
        "East": -3
    },
    ...
    repNoEncounterText=(
        reset +
        "The wolves recognize your scent, and your place as a friend of nature."
    ),
    findNoEncounterText=
    (reset +
     "Eyes are upon you, their gazes not friendly at all, filled with hunger."
     ),
    noMoreMobsText=(reset + "The dim tunnel seems empty now."),
    encounter=mobDict["Hungry Wolf"],
    encounterChance=25,
    lootTable={
        "Rolls": 1,
...
dungeonTile3 = Tile(
    (reset +
     "A cramped tunnel framed by collapsed stones leads ever deeper here."),
    ("The darkness makes everything difficult to make out.\nThere is barely any light to speak of, aside from the shining of magical fungi clinging to the cave walls."
     ),
    -3, {
        "West": -2,
        "East": -4
    ...
    tileNotFoundText=(gold + "You bump into a stone wall in the darkness."),
    findNoEncounterText=
    "You sense what seems to be a presence in this darkness,\nof creatures that inhabit the underground that don't seem so welcoming to their visitor.",
    repNoEncounterText=
    "The unfriendly gazes don't hold so much malice any more.",
    noMoreMobsText=
    "This place has been deserted, as even the faint noises on the corner of your hearing disappeared.",
    encounter=mobDict["Kobold Scout"],
    encounterChance=15)

dungeonTile4 = Tile(
    (reset +
     "You are in a large cavern, with a steep drop away from the cave opening a little bit higher than your current position. It's lit by small growths of shining crystal and mushrooms."
     ),
    ...
    encounterChance=10,
    findNoEncounterText=
    "The mushrooms glow serenely on the walls. Underground vegetation is certainly far different from that of the surface.",
    noMoreMobsText="The place could even be described as peaceful.",
    entryEncounter=True,
    lootTable={
        "Rolls": 1,
        "Quartz Stone": 1,
...
dungeonTile5 = Tile(
    (reset +
     "Most of the cave's inhabitants appear to be quite shy of your intrusion, making themselves scarce whenever you come near."
     ),
    ...
    encounterChance=8,
    findNoEncounterText=
    "You hear the lumbering of large creatures in the darkness. Who knew that things in a cave like this could grow to such sizes?",
    noMoreMobsText=
